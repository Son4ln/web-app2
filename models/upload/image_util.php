<?php
function process_image1($dir, $filename) {
    ...
    $image_path_200 = $dir .'hinh_'. $image_name .'_200'. $ext;
    
    // Create an image that's a maximum of 200x200 pixels
    resize_image($image_path, $image_path_200, 200, 200);
    $image = 'hinh_'. $image_name .'_200'. $ext;
    return $image;
}
