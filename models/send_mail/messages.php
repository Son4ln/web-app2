<?php
	...
	$message  = '<center><h3 style="color:#F00;">CONTACT</h3></center>
                    <div style="text-indent:100px; margin-left:100px;">
                        <p><span style="color:#F00;">- Letter sent from: </span>'.$fname.'</p>
                        <p><span style="color:#F00;">- Email: <span>'.$from.'</p>
                        <p><span style="color:#F00;">- Address: </span>'.$address.'</p>
                        <p><span style="color:#F00;">- Message: </span>'.$body.'</p></div>';
    // Send the email
    ...
    function send_email_forgot($username, $user_email, $pw) {
       ...
       // Add the email address to the list of all recipients
        ...
        //khai báo nội dung thư theo chuẩn HTML
	$message  = '<center><h3 style="color:#F00;">CONFIRM PASSWORD</h3></center>
                    <div style="text-indent:100px; margin-left:100px;">
                        <p>You forgot your password. </p><p> Your new password is:<span style="color:#F00;">'.$pw.'<span></p>
